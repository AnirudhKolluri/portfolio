...
<body style="background:url('https://cdn.wallpapersafari.com/34/59/8L5i6X.jpg') top right no-repeat;">
...
?>
          ...
          <li><a class="nav-link" href="#services">Teaching</a></li>
          <?php
}
...
while($skill=mysqli_fetch_array($run3)){
   ?>
          <div class="progress">
            <span class="skill"><?=$skill['skill_name']?> <i class="val"><?=$skill
            ['skill_level']?> %</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="<?=$skill
              ['skill_level']?>" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          <?php
        }
    ...
    <div class="interests container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4">
          <div class="icon-box">
            <i class="ri-cloud-fill" style="color: #ffbb2c;"></i>
            <h3>Cloud Computing</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
          <div class="icon-box">
            <i class="ri-amazon-fill" style="color: #5578ff;"></i>
            <h3>AWS</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
          <div class="icon-box">
            <i class="ri-google-fill" style="color: #e80368;"></i>
            <h3>Google Cloud Platform</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
          <div class="icon-box">
            <i class="ri-infinity-fill" style="color: #e361ff;"></i>
            <h3>DevOps</h3>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            ...
            <h3>Containers and Dockers</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <i class="ri-robot-2-fill" style="color: #b2904f;"></i>
            <h3>Robotic Process Automation and CI/CD</h3>
          </div>
        </div>
...
?>
   ...
   <div class="bg-name" style="background-image:url('images/bi.jpg');">
    <div class="container">
      ...
      <div class="row">
        ...
        while($services=mysqli_fetch_array($run6)){
          if($services['id']=='1'){

        ?>
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><i class="ri-cloud-fill"></i></div>
            <h4><?=$services['subject_title']?></h4>
            <p><?=$services['subject_subtitle']?></p>
          </div>
        </div>
        <?php
        }
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><i class="ri-braces-line"></i></div>
            <h4><?=$services['subject_title']?></h4>
            <p><?=$services['subject_subtitle']?></p>
          </div>
        </div>
            ...
            if($services['id']=='8'){
              ...
              if($services['id']=='9'){
                ...
                if($services['id']=='10'){
                  ...
                  <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="icon-box">
                      <div class="icon"><i class="ri-product-hunt-line"></i></div>
                      <h4><?=$services['subject_title']?></h4>
                      <p><?=$services['subject_subtitle']?></p>
                    </div>
                  </div>
                  ...
                  if($services['id']=='11'){
                    ...
                    if($services['id']=='12'){
                      ...
                      <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="icon-box">
                          <div class="icon"><i class="ri-repeat-2-fill]"></i></div>
                          <h4><?=$services['subject_title']?></h4>
                          <p><?=$services['subject_subtitle']?></p>
                        </div>
                      </div>
...
?>
      ...
      <div class="section-title">
        ...
        <p>Check My Details</p>
      </div>
        
            <div class="col-lg-6">
              <ul>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>Research field --</strong><span>1 May 1995</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>Open Research problems -- </strong> <span>www.example.com</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>Research  Scholars[phd, pg]--</strong> <span>+123 456 7890</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong> UG project --</strong> <span>New York, USA</span></h5></li>
              </ul>
            </div>
            <div class="col-lg-6">
              <ul>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>Google scholar --</strong> <span>30</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>Details of the papers:--</strong> <span>Master</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>IEEE membership id --</strong> <span>email@example.com</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>ACM membership id --</strong> <span>Available</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>DBLP --</strong> <span>Available</span></h5></li>
                <li><h5><i class="bi bi-chevron-right"></i> <strong>Scopus --</strong> <span>Available</span></h5></li>
              </ul>
            </div>
          </div>
